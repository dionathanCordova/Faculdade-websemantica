...
<div class="row about-container">
    ...
    <div class='container'>
        ...
        <form action="<?php echo base_url('Busca/pdfconsulta')?>" method='post'>
            <input type="text" name='nomeConsulta' id='nomeConsulta' hidden>
            <input type="text" name='cpfConsulta' id='cpfConsulta' hidden>
			...
			$.ajax({
                ...
                success:function(data) {
					...
					if(data.NAVEGANTES != null || data.NAVEGANTES != 0) {
						htmlNAVEGANTES = data.NAVEGANTES;
					}

					if(data.PORTO_BELO != null || data.PORTO_BELO != 0) {
						htmlPORTO_BELO = data.PORTO_BELO;
					}

					if(data.PICARRAS != null || data.PICARRAS != 0) {
						htmlPICARRAS = data.PICARRAS;
					}

					$('#Result').html(htmlBC +  htmlITAJAI + htmlPICARRAS + htmlCAMBORIU + htmlNAVEGANTES + htmlPORTO_BELO);
                }
            });
		})
	</script>