    ...
    <div class="container-fluid">
        <div class="row about-container">
            <div class='container'>
                ...
                <div class='pull-center text-center' id="imgLoading2" hidden>
                    <img  src="<?php echo base_url('assets/img/loading.gif')?>" alt="carrregando dados" width='40'>
                </div>
...
<script>
  $(document).ready(function() { 
    ...
    $('#btnCruzamento').click(function() {
        ...
        let listaMunicipios = ['balneario_camboriu', 'navegantes', 'camboriu', 'itajai', 'porto_belo', 'picarras', 'ilhota', 'itapema', 'luiz_alves', 'bombinhas', 'penha'];
    ...
    const download = document.querySelector('.dadosServidorCruzado');
    if(download) {
        download.addEventListener('click', e => {
            // if(e.target.className === 'btn btn-primary btn-xs btnViewCruzamento') {
            //     const id = e.target.getAtribute('value');
